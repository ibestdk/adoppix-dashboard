    ...
    <div className="mx-4 mt-10 w-full">
      ...
      <div className="w-2/5">
        <div className="w-full mb-4">
          ...
          <input type="email" className="p-1 w-1/2 rounded-lg" onChange={handleEmailChange} value={email}/>
        </div>
        <div className="w-full mb-4">
          <p className="mb-1">ชื่อผู้ใช้</p>
          <input type="text" className="p-1 w-1/2 rounded-lg" onChange={handleUsernameChange} value={username}/>
        </div>
        <div className="w-full mb-4">
          <p className="mb-1">รหัสผ่าน</p>
          <input type="password" className="p-1 w-1/2 rounded-lg" onChange={handlePasswordChange} value={password}/>
        </div>
        <div className="w-full mb-4">
