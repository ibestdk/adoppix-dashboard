                  ...
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                      ...
                      <div className="relative mt-5 overflow-hidden w-full">
                        ...
                        <button
                          disabled={isLoadingSendMessage}
                          className="absolute right-0 top-0 bottom-0 m-auto rounded-lg px-3 bg-blue-500 text-white cursor-pointer hover:bg-blue-800 transition disabled:bg-gray-500 disabled:cursor-not-allowed"
                          onClick={onReply}
                        >
                          ตอบกลับ
                        </button>
