  ...
  return (
    <div className="container mx-auto mt-10">
      <div className="flex justify-between">
        ...
        <div>
          <div className=" bg-cu py-2 px-6 cursor-pointer  rounded-md text-white font-bold ">
            เพิ่ม
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-5 gap-4 mt-10">
          {blog &&
            blog.blogList.map((b, index) => (
              <div className="bg-white p-2 rounded-md shadow-md" key={b.id}>
                <div>
                  <div className="flex justify-between">
